<%-- 
    ...
    Created on : 21-sep-2015, 23:48:40
    Author     : Walter
--%>
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            ...
            <div class="panel-body">
                ...
                <form:form method="POST" action="${pageContext.request.contextPath}/Usuario/edit/${usuario.idUsuario}" modelAttribute="usuario" id="usuarioF">
