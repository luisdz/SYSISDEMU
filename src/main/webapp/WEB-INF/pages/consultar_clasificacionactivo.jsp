    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-white">
            <div class="panel-heading">
                <h4 class="panel-title">Consultar <span class="text-bold">Clase Activo</span> Activos Fijos</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover" id="sample-table-2">
                        ...
                        <tbody>
                            ...
                            <c:forEach var="clasi" items="${clasiA}">
                                <tr >
                                    <td class="no-display">${clasi.idClasificacionActivo}</td>
                                    <td>${clasi.nombreClasificacion}</td>
                                    <td>${clasi.codigoClasificacion}</td>
